...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/public/js/gererEtudiant.js" />"  async defer></script>
</head>
<body>
...
<main class="container">
    ...
    <div class="row mt-5 justify-content-md-center">
        <div class="col-md-4  bg-info rounded">
            ...
            <form id="form-gererEtudiant" method="post" action="GererEtudiant">
                ...
                <div class="col-md-12 mt-2">
                    <select name="etudiantSelect" id="etudiantSelect" class="form-select">
                        <option selected disabled>Séléctionner un étudiant</option>
                ...
                <div class="row mt-4">
                    <div class="col text-center">
                        <input type="submit" class="btn btn-outline-success mb-2"  value="modifier" id="modifier">
                        <button id="delete" name="delete" type="button" class="btn btn-outline-danger mb-2">Supprimer</button>
                    </div>
                </div>
                <div class="col-md-12 row text-center">
